...
//    navigateTo: (Any?) -> Unit,
    ...
    fun testHomeScreenOffline() {
        ...
        composeTestRule.onNodeWithText(
            "House", ignoreCase = true, substring = true
        ).assertExists()
        ...
        composeTestRule.onNodeWithText("Retry", ignoreCase = true, substring = true)
            .assertHasClickAction()
        composeTestRule.onNodeWithText(
            "No Internet Connection found.", ignoreCase = true, substring = true
        ).assertExists()
    ...
    fun testHomeScreenLoading() {
        ...
        composeTestRule.onNodeWithText("House", ignoreCase = true, substring = true)
            .assertDoesNotExist()
        composeTestRule.onNodeWithText(
            "No network detected, previewing offline data", ignoreCase = true, substring = true
        ).assertDoesNotExist()
        composeTestRule.onNodeWithText("Retry", ignoreCase = true, substring = true)
            .assertDoesNotExist()
        composeTestRule.onNodeWithText(
    ...
    fun testHomeScreenError() {
        ...
        composeTestRule.onNodeWithText("Retry", ignoreCase = true, substring = true)
            .assertHasClickAction()
        composeTestRule.onNodeWithText(
            "Server is down", ignoreCase = true, substring = true
        ).assertExists()
    ...
    fun testHomeScreenAddDialogOpen() {
        ...
        composeTestRule.onNodeWithText("Name", ignoreCase = true, substring = true)
            .assertExists()
        composeTestRule.onNodeWithText("Country", ignoreCase = true, substring = true)
            .assertExists()
        composeTestRule.onNodeWithText("Street Number", ignoreCase = true)
            .assertExists()
        composeTestRule.onNodeWithText(
            "Type", ignoreCase = true, substring = true
        ).assertExists()
